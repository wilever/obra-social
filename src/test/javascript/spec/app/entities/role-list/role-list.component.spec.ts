...
import { RoleListComponent } from 'app/entities/role-list/role-list.component';
...
describe('Component Tests', () => {
    describe('RoleList Management Component', () => {
        let comp: RoleListComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(RoleListComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.roleLists[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
