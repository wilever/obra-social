...
export class RoleTypeComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.roleTypeService
            ...
            .subscribe(
                (res: HttpResponse<IRoleType[]>) => this.paginateRoleTypes(res.body, res.headers),
    ...
    registerChangeInRoleTypes() {
        this.eventSubscriber = this.eventManager.subscribe('roleTypeListModification', response => this.loadAll());
    }
    ...
    protected paginateRoleTypes(data: IRoleType[], headers: HttpHeaders) {
